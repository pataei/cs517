\newcommand{\valid}[1]{\OB{\mathit{valid} \left({#1} \right)}}
\newcommand{\deadl}[1]{\OB{\mathit{dead}_l \left( {#1} \right)}}
\newcommand{\deadr}[1]{\OB{\mathit{dead}_r \left( {#1} \right)}}
\newcommand{\rdnt}[1]{\OB{\mathit{rdnt} \left({#1}\right)}}
